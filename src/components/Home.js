...
function Home() {
    return (
        <div id="home">
            ...
            <p>Navigate to the <b>Students</b> page to view students currently enrolled at Pokemon Academy. You may view their names, class year, the courses they are enrolled in this semester, and their current grade in each course. If you wish, you can filter students by class year, or sort students alphabetically by last name. You can also add new student information if a new student has joined Pokemon Academy.</p>
